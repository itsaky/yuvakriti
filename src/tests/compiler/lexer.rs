...
fn check_diagnostic_messages(diag_handler: &CollectingDiagnosticHandler, expected_messages: &Vec<&str>) {
...
fn test_lexer_reports_unrecognized_tokens() {
    ...
    check_diagnostic_messages(&diag_handler.borrow(), &vec![
